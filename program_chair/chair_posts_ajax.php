...
try {
    ...
    if (count($result) > 0) {
        foreach ($result as $row) {
            ...
            $table_html .= '<button onclick="setCurrentJobId(' . $row['id'] . '); showModal(\'deleteModal\')" class="text-red-600 hover:text-red-900 hover:bg-red-50 p-1 rounded transition-colors duration-200" title="Delete"><i class="fas fa-trash"></i></button>';

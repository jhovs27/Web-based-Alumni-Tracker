<?php
$alumni_name = $_SESSION['alumni_name'] ?? $alumni['first_name'] . ' ' . $alumni['last_name'] ?? 'Alumni';
$profile_photo = $alumni['profile_photo_path'] ?? '';
if (!empty($profile_photo) && file_exists('../admin/uploads/profile_photos/' . $profile_photo)) {
    $profile_photo_url = '../admin/uploads/profile_photos/' . htmlspecialchars($profile_photo);
} else {
    $profile_photo_url = 'https://ui-avatars.com/api/?name=' . urlencode($alumni_name) . '&background=0D8ABC&color=fff';
}
?>
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="hidden sm:flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-lg font-bold text-gray-900 tracking-tight">SLSU-HC Alumni Portal</h1>
                        <p class="text-sm text-gray-600 hidden md:block">Welcome back, <span class="text-blue-600 font-medium"><?php echo htmlspecialchars($alumni_name); ?></span></p>
                    </div>
                </div>
            </div>
                    ...
                    <div id="profileMenu" class="hidden absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl py-2 z-50 border border-gray-200 backdrop-blur-sm">
                        ...
                        <div class="px-4 py-3 border-b border-gray-100">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-gray-900"><?php echo htmlspecialchars($alumni_name); ?></p>
                        ...
                        <!-- Menu Items -->
                        <div class="py-2">
                            <a href="profile.php" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-all duration-200 group">
                            ...
                            <a href="settings.php" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 group">
